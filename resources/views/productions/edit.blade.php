...
<div class="form-wrap">
  ...
  <div class="form-card">
    ...
    <div class="form-card-body">
      <form method="POST" action="{{ route('solar-systems.productions.update', [$solarSystem, $production]) }}">
        @csrf
        @method('PUT')
              ...
              <div class="select-wrap">
                <select class="@error('panel_id') is-invalid @enderror" id="panel_id" name="panel_id">
                  ...
                  @foreach($panels as $panel)
                    <option value="{{ $panel->id }}" {{ old('panel_id', $production->panel_id) == $panel->id ? 'selected' : '' }}>
          ...
          <div class="form-grid-2">
            ...
            <div class="form-field">
              ...
              <input type="number" id="energy_produced_kwh" name="energy_produced_kwh"
                     value="{{ old('energy_produced_kwh', $production->energy_produced_kwh) }}"
            ...
            <div class="form-field">
              ...
              <input type="number" id="energy_consumed_kwh" name="energy_consumed_kwh"
                     value="{{ old('energy_consumed_kwh', $production->energy_consumed_kwh) }}"
                     placeholder="0.00" step="0.01" min="0"
            ...
            <div class="form-field">
              ...
              <input type="number" id="peak_power_kw" name="peak_power_kw"
                     value="{{ old('peak_power_kw', $production->peak_power_kw) }}"
                     placeholder="0.00" step="0.01" min="0"
            ...
            <div class="form-field">
              ...
              <input type="number" id="average_power_kw" name="average_power_kw"
                     value="{{ old('average_power_kw', $production->average_power_kw) }}"
                     placeholder="0.00" step="0.01" min="0"
        ...
        <div class="form-section">
          ...
          <div class="form-grid-2" style="margin-bottom:18px;">
            ...
            <div class="form-field">
              ...
              <input type="number" id="irradiance_wm2" name="irradiance_wm2"
                     value="{{ old('irradiance_wm2', $production->irradiance_wm2) }}"
                     placeholder="0.00" step="0.01" min="0"
            ...
            <div class="form-field">
              ...
              <input type="number" id="temperature_celsius" name="temperature_celsius"
                     value="{{ old('temperature_celsius', $production->temperature_celsius) }}"
          ...
          {{-- Weather visual picker --}}
          @php $curWeather = old('weather_condition', $production->weather_condition); @endphp
          <div class="form-field">
            <label>Weather Condition <span class="field-hint">(Optional)</span></label>
            <div class="weather-options">

              <div>
                <input type="radio" name="weather_condition" id="w_sunny" value="sunny" class="weather-opt" {{ $curWeather === 'sunny' ? 'checked' : '' }}>
              ...
              <div>
                <input type="radio" name="weather_condition" id="w_partly" value="partly_cloudy" class="weather-opt" {{ $curWeather === 'partly_cloudy' ? 'checked' : '' }}>
              ...
              <div>
                <input type="radio" name="weather_condition" id="w_cloudy" value="cloudy" class="weather-opt" {{ $curWeather === 'cloudy' ? 'checked' : '' }}>
              ...
              <div>
                <input type="radio" name="weather_condition" id="w_rainy" value="rainy" class="weather-opt" {{ $curWeather === 'rainy' ? 'checked' : '' }}>
        ...
        <div class="form-footer">
          ...
          <a href="{{ route('solar-systems.productions.show', [$solarSystem, $production]) }}" class="btn-cancel">Cancel</a>
        </div>
      ...
      <div class="danger-zone">
        ...
        <form method="POST" action="{{ route('solar-systems.productions.destroy', [$solarSystem, $production]) }}" onsubmit="return confirm('Are you sure you want to delete this record?')">
          @csrf
          @method('DELETE')
